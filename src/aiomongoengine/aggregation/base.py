...
from ..query_builder.transform import update
...
class Aggregation(object):
    ...
    async def fetch(self, callback=None, alias=None):
        ...
        return await coll.aggregate(self.to_query()).to_list(None)

    @classmethod
    def avg(cls, field, alias=None):
        from .avg import AverageAggregation
        return AverageAggregation(field, alias)

    @classmethod
    def sum(cls, field, alias=None):
        from .sum import SumAggregation
